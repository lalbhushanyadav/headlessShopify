...
const InputField = ({ id, label, type, value, onChange, error }) => (
  <div className="mb-4">
    ...
    <input
      ...
      value={value}
      onChange={onChange}
      className="w-full px-4 py-2 text-black dark:text-white border border-black dark:border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
    />
